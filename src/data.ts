...
const NEW_PRODUCTS_TO_ADD: Product[] = [
  {
    ...
    price: 3999,
    salePrice: 1499,
    description: 'Stay focused on the journey with the TEECODE Obsess Over Progress Oversized T-Shirt.\n\nFeaturing a powerful motivational back graphic centered around “OBSESS OVER PROGRESS, NOT PERFECTION”, this statement tee is designed for those who believe in consistency, discipline, and everyday improvement.\n\nThe relaxed oversized fit delivers a comfortable streetwear silhouette, while the minimal front TEECODE branding keeps the look clean from the front. The detailed back artwork adds a distinctive gym-inspired aesthetic.\n\nPair it with joggers, cargos, training shorts, or relaxed-fit bottoms for a complete workout or streetwear look.',
    fit: 'Oversized / Relaxed',
    fitType: 'Oversized',
    gsm: 240,
    material: '240 GSM Premium 100% Combed Cotton, comfortable everyday construction',
    printFront: 'Minimal TEECODE front branding',
    printBack: 'Motivational back graphic with “OBSESS OVER PROGRESS, NOT PERFECTION” typography and detailed fitness-inspired artwork',
    style: 'Gym / Streetwear',
    ...
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097134/Black_Front_TEECODE_mlyv07.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097134/Black_Back_wzafn8.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097134/Black_Side_jigsny.webp',
    ],
    colorImages: {
      'Black': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097134/Black_Front_TEECODE_mlyv07.webp',
      ...
      'White': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097135/White_Front_TEECODE_od2joh.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097135/White_Back_tcweix.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097136/White_Side_frvric.webp',
      ],
      'Maroon': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097134/Maroon_Front_TEECODE_do3kxv.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097135/Maroon_Back_bitq98.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097134/Maroon_Side_o9jb5j.webp',
      ],
      'Grey': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097135/Grey_Front_TEECODE_gjrwvg.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097134/Grey_Back_d9x9co.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1790097135/Grey_Side_ugud0q.webp',
      ],
    },
    category: 'new',
    gender: 'men',
    tshirtType: 'Oversized Collection',
    additionalTypes: ['TeeCode Training Gear', 'Oversized Collection'],
    tag: '62% OFF',
    graphicDesc: 'A bold oversized graphic T-shirt featuring the motivational “OBSESS OVER PROGRESS, NOT PERFECTION” artwork. Designed for modern gym, fitness, and streetwear styling with a relaxed silhouette and statement back graphic.',
    washingInstructions: [
      'Machine wash cold',
    ...
    seoTitle: 'TEECODE Obsess Over Progress Oversized T-Shirt | Gym & Fitness Streetwear',
    metaDescription: 'Shop the TEECODE Obsess Over Progress Oversized T-Shirt featuring a motivational back graphic and relaxed oversized fit. Available in Black, White, Maroon, and Grey in sizes XXS to XL. Perfect for gym, fitness, and streetwear styling.',
  },
  {
    id: 'teecode-tokyo-ghoul-anime-oversized-t-shirt',
    name: 'TEECODE Tokyo Ghoul Anime Oversized T-Shirt',
    price: 1999,
    salePrice: 999,
    description: 'Bring the energy of anime culture into your everyday wardrobe with the TEECODE Tokyo Ghoul Anime Oversized T-Shirt.\n\nFeaturing striking character artwork, Japanese-inspired typography, and detailed graphic elements, this statement tee delivers a distinctive manga-inspired aesthetic. The oversized relaxed silhouette provides comfortable movement while creating a modern streetwear appearance.\n\nPair it with baggy jeans, cargos, joggers, shorts, or sneakers for an effortless everyday outfit. Perfect for anime enthusiasts, gaming, college, conventions, travel, and casual streetwear.',
    fit: 'Oversized / Relaxed',
    fitType: 'Oversized',
    gsm: 240,
    material: '240 GSM Premium 100% Combed Cotton, comfortable everyday construction',
    printFront: 'Statement front print featuring detailed anime character illustration and Japanese-inspired typography',
    printBack: 'Clean plain back',
    style: 'Anime Streetwear — Unisex-inspired styling',
    sizes: ['XXS', 'XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Black', hex: '#0F0F11' },
      { name: 'Red', hex: '#DC2626' },
    ...
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320853/07_Black_Leaning_Front_pivhks.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320853/08_Black_Front_Center_c4g9pu.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320853/09_Black_Back_Plain_x1faby.webp',
    ],
    colorImages: {
      'Black': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320853/07_Black_Leaning_Front_pivhks.webp',
      ...
      'Red': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320851/01_Red_Leaning_Front_mmies4.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320851/02_Red_Front_Center_r7qf7l.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320852/03_Red_Back_Plain_fnmaq5.webp',
      ],
      'White': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320852/05_White_Front_Center_yhej1w.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320852/06_White_Back_Plain_d8dtj2.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1789320851/04_White_Leaning_Front_dqubim.webp',
      ],
    },
    category: 'new',
    gender: 'men',
    tshirtType: 'Anime Code',
    additionalTypes: ['Oversized Collection', 'Anime Code', 'Graphic Universe'],
    tag: '50% OFF',
    graphicDesc: 'A bold anime-inspired oversized graphic T-shirt featuring detailed character artwork and Japanese-inspired typography. Designed for anime fans who want a statement streetwear look with an effortless oversized fit.',
    washingInstructions: [
      'Machine wash cold',
      'Wash inside out to protect the graphic',
      'Use mild detergent',
    ...
    seoTitle: 'TEECODE Tokyo Ghoul Anime Oversized T-Shirt | Japanese Graphic Streetwear',
    metaDescription: 'Shop the TEECODE Tokyo Ghoul Anime Oversized T-Shirt featuring detailed anime-inspired artwork and Japanese-inspired typography. Available in Black, Red, and White in sizes XXS to XL. Perfect for anime fans and streetwear lovers.',
  },
  {
  ...
  },
  {
    ...
    price: 1499,
    salePrice: 699,
    description: 'Train with confidence in the TEECODE Performance Essential Athletic T-Shirt.\n\nDesigned with a lightweight technical fabric and a streamlined athletic fit, this T-shirt provides comfortable movement during workouts while maintaining a clean, modern appearance.\n\nThe breathable textured construction helps promote airflow, while the stretch-friendly design allows unrestricted movement during training, running, gym sessions, or everyday activities.\n\nWith its minimalist design and versatile styling, this performance tee transitions easily from the gym to casual everyday wear.\n\nFit Note: Designed to provide a comfortable athletic fit without restricting movement. Choose your usual size for the ideal athletic silhouette.',
    fit: 'Athletic / Regular',
    fitType: 'Regular',
    gsm: 180,
    material: 'Lightweight technical performance fabric with breathable textured construction and comfortable stretch',
    printFront: 'Minimalist TEECODE detailing',
    printBack: 'Clean minimal back',
    style: 'Performance / Activewear — Men\'s / Gym',
    sizes: ['XXS', 'XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Black', hex: '#0F0F11' },
    ...
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949907/Screenshot_2026-09-09_at_16.00.21_zn9yre.png',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949909/Screenshot_2026-09-09_at_16.00.28_zac5ai.png',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949910/Screenshot_2026-09-09_at_16.00.35_o3kwt1.png',
    ],
    colorImages: {
      'Black': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949907/Screenshot_2026-09-09_at_16.00.21_zn9yre.png',
      ...
      'Dark Grey': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949907/Screenshot_2026-09-09_at_16.00.48_tbztb7.png',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949907/Screenshot_2026-09-09_at_16.00.55_zvscnp.png',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949908/Screenshot_2026-09-09_at_16.01.03_oq9he7.png',
      ],
      'Light Grey': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949905/Screenshot_2026-09-09_at_15.59.57_l3t3pt.png',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949906/Screenshot_2026-09-09_at_16.00.03_ppr9oy.png',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788949906/Screenshot_2026-09-09_at_16.00.12_tlklnm.png',
      ],
    },
    category: 'new',
    gender: 'men',
    tshirtType: 'TeeCode Training Gear',
    additionalTypes: ['TeeCode Training Gear'],
    tag: '53% OFF',
    graphicDesc: 'A modern performance T-shirt designed for active lifestyles, combining lightweight comfort, breathable fabric, and a clean athletic silhouette. Built for training, workouts, and everyday movement.',
    washingInstructions: [
      'Machine wash cold',
  ...
  {
    id: 'teecode-tropical-vibes-graphic-oversized-t-shirt',
    name: 'TEECODE Tropical Vibes Graphic Oversized T-Shirt',
    price: 1999,
    salePrice: 799,
    description: 'Bring a relaxed summer-inspired attitude to your wardrobe with the TEECODE Tropical Vibes Graphic Oversized T-Shirt.\n\nFeaturing a distinctive “TROPICAL VIBES” graphic with botanical-inspired detailing, this statement tee adds a fresh and stylish touch to everyday outfits. The oversized silhouette creates an effortless look while providing comfortable movement throughout the day.\n\nPair it with wide-leg jeans, cargos, shorts, skirts, or sneakers for an easy casual outfit. Perfect for everyday wear, college, travel, vacations, weekend outings, and streetwear styling.\n\nStyle Note: Designed for an intentionally oversized fit. Choose your usual size for the full relaxed look or select one size smaller for a more fitted appearance.',
    fit: 'Oversized / Relaxed',
    fitType: 'Oversized',
    gsm: 240,
    material: '240 GSM Premium Cotton',
    printFront: 'Tropical-inspired “TROPICAL VIBES” graphic with botanical detailing',
    printBack: 'Plain back',
    style: 'Casual Streetwear — Women\'s / Unisex',
    sizes: ['XXS', 'XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Yellow', hex: '#F5C518' },
      { name: 'Red', hex: '#DC2626' },
    ...
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932721/yellow_tropical_vibes_tee_xgqtvz.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932720/woman_back_view_yellow_tee_wisj7b.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932719/full_body_tropical_vibes_uceqme.webp',
    ],
    colorImages: {
      'Yellow': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932721/yellow_tropical_vibes_tee_xgqtvz.webp',
      ...
      'Red': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932719/red_tshirt_vibes_b7jdat.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932720/woman_back_view_1_ru2vv8.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932720/side_profile_tropical_vibes_b3leak.webp',
      ],
      'Black': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932720/tropical_vibes_photoreal_tewvik.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932720/tropical_vibes_side_profile_oatlox.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932718/full_body_streetwear_photoshoot_rmlj0i.webp',
      ],
      'Sky Blue': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932719/sky_blue_tropical_tshirt_yxvqdn.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932719/back_view_woman_sky_blue_rkt6hl.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788932719/full_body_tropical_vibes_streetwear_mbsite.webp',
      ],
    },
    category: 'new',
    gender: 'women',
    ...
    tag: '60% OFF',
    graphicDesc: 'A relaxed oversized graphic T-shirt featuring a tropical-inspired “TROPICAL VIBES” graphic with a clean contemporary aesthetic. Designed for effortless everyday styling, comfort, and modern streetwear looks.',
    washingInstructions: [
      'Machine wash cold',
      'Wash inside out to protect the graphic',
      'Use mild detergent',
  ...
  {
    id: 'teecode-chaos-reaper-graphic-oversized-t-shirt',
    name: 'TEECODE Chaos Reaper Graphic Oversized T-Shirt',
    price: 2000,
    salePrice: 999,
    description: 'Step into bold streetwear with the TEECODE Chaos Reaper Graphic Oversized T-Shirt.\n\nFeaturing a powerful dark reaper-inspired illustration surrounded by dramatic rose details and bold CHAOS typography, this T-shirt delivers an intense gothic aesthetic with a modern streetwear edge.\n\nThe statement front graphic makes it the perfect choice for anyone who wants their outfit to stand out. Its relaxed oversized silhouette provides everyday comfort and can be styled effortlessly with cargos, jeans, joggers, or shorts.\n\nPerfect for streetwear lovers, graphic fashion enthusiasts, and those who prefer bold and artistic designs.\n\nStyle Note: Designed for an intentionally oversized fit. Choose your usual size for the full relaxed look or size down for a slightly more fitted silhouette.',
    fit: 'Oversized / Relaxed',
    fitType: 'Oversized',
    gsm: 240,
    material: '240 GSM Premium Cotton',
    printFront: 'Dark reaper-inspired artwork with skull imagery, rose graphics, and bold CHAOS typography',
    printBack: 'Plain back',
    style: 'Gothic Graphic Streetwear — Men\'s / Unisex',
    sizes: ['XXS', 'XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Black', hex: '#0F0F11' },
      { name: 'Red', hex: '#DC2626' },
    ...
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892861/RED_side_lvwyrn.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892864/WHITE_sitting_b2nd82.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892859/RED_back_plain_qey8xl.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892863/WHITE_front_nu2wjk.webp',
    ],
    colorImages: {
      'Black': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892861/RED_side_lvwyrn.webp',
      ...
      'Red': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892861/RED_sitting_pkzuds.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892860/RED_front_zkf7zd.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892862/WHITE_back_plain_e1onc1.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892859/BLACK_front_zdb5yr.webp',
      ],
      'White': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892859/BLACK_side_v3f1il.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892860/BLACK_sitting_xwffol.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892858/BLACK_back_plain_qzkyhh.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788892863/WHITE_side_wvcv2q.webp',
      ],
    },
    category: 'new',
    gender: 'men',
    ...
    additionalTypes: ['Oversized Collection', 'Anime Code', 'Graphic Universe'],
    tag: '50% OFF',
    graphicDesc: 'A bold oversized graphic T-shirt featuring a dark reaper-inspired artwork, striking skull imagery, gothic typography, and detailed rose graphics.',
    washingInstructions: [
      'Machine wash cold',
      'Wash inside out to protect the graphic',
      'Use mild detergent',
  ...
  {
    id: 'teecode-oni-spirit-graphic-oversized-t-shirt',
    name: 'TEECODE Oni Spirit Graphic Oversized T-Shirt',
    price: 2000,
    salePrice: 999,
    description: 'Unleash your bold side with the TEECODE Oni Spirit Graphic Oversized T-Shirt.\n\nFeaturing a powerful demon mask-inspired graphic, expressive Japanese-style artwork, and the statement “ONI SPIRIT” design, this T-shirt brings a unique fusion of Japanese-inspired aesthetics and contemporary streetwear.\n\nThe relaxed oversized silhouette offers effortless comfort and makes this tee easy to style with cargos, jeans, joggers, shorts, and layered streetwear outfits.\n\nAvailable in Red, White, and Black, the TEECODE Oni Spirit Graphic Oversized T-Shirt is made for those who want their style to stand out.\n\nStyle Note: Designed for an intentionally oversized fit. Choose your usual size for the full relaxed look or size down for a slightly more fitted silhouette.',
    fit: 'Oversized / Relaxed',
    fitType: 'Oversized',
    gsm: 240,
    material: '240 GSM Premium Cotton',
    printFront: 'Bold Oni-inspired demon mask artwork with Japanese-style typography',
    printBack: 'Plain back',
    style: 'Japanese-inspired Graphic Streetwear — Men\'s / Unisex',
    sizes: ['XXS', 'XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Red', hex: '#DC2626' },
      { name: 'White', hex: '#FFFFFF' },
    ...
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889993/RED_sitting_isk2rb.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889993/RED_front_yxblqo.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889993/RED_back_plain_nv5pht.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889992/BLACK_side_nuq235.webp',
    ],
    colorImages: {
      'Red': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889993/RED_sitting_isk2rb.webp',
      ...
      'White': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889994/WHITE_sitting_qp1syx.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889994/WHITE_front_nvh3hv.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889992/BLACK_side_nuq235.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889993/WHITE_back_plain_esdzhu.webp',
      ],
      'Black': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889993/BLACK_sitting_zbs9qx.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889992/BLACK_front_pq6xhs.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889992/BLACK_side_nuq235.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889992/BLACK_back_plain_m63qk5.webp',
      ],
    },
    category: 'new',
    gender: 'men',
    ...
    additionalTypes: ['Oversized Collection', 'Anime Code', 'Graphic Universe'],
    tag: '50% OFF',
    graphicDesc: 'A bold oversized graphic T-shirt featuring a striking Oni-inspired mask artwork with powerful Japanese-style typography and edgy streetwear detailing.',
    washingInstructions: [
      'Machine wash cold',
      'Wash inside out to protect the graphic',
      'Use mild detergent',
  ...
  {
    id: 'teecode-fallen-angel-graphic-oversized-t-shirt',
    name: 'TEECODE Fallen Angel Graphic Oversized T-Shirt',
    price: 2000,
    salePrice: 999,
    description: 'Make a statement with the TEECODE Fallen Angel Graphic Oversized T-Shirt. Featuring powerful angel-inspired artwork, distressed graphic details, and bold TEECODE branding, this T-shirt brings a dark, artistic edge to modern streetwear.\n\nThe relaxed oversized silhouette provides a comfortable and effortless fit, making it easy to style with jeans, cargos, joggers, shorts, or layered outfits.\n\nAvailable in multiple color options, this graphic tee is designed for those who want their everyday fashion to stand out.\n\nStyle Note: Designed for an intentionally oversized fit. Choose your usual size for the full relaxed look or size down for a slightly more fitted silhouette.',
    fit: 'Oversized / Relaxed',
    fitType: 'Oversized',
    gsm: 240,
    material: '240 GSM Premium Cotton',
    printFront: 'Fallen angel-inspired artwork with bold distressed typography',
    printBack: 'Plain back',
    style: 'Graphic Streetwear — Men\'s / Unisex',
    sizes: ['XXS', 'XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { name: 'White', hex: '#FFFFFF' },
      { name: 'Black', hex: '#0F0F11' },
    ...
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889204/WHITE_sitting_fcgwq0.webp',
    ...
    colorImages: {
      ...
      'Black': [
        ...
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889202/BLACK_back_plain_nb7ill.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889204/WHITE_side_k6aian.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788889202/BLACK_front_s2syfa.webp',
      ],
    },
    category: 'new',
    gender: 'men',
    ...
    tag: '50% OFF',
    graphicDesc: 'TEECODE Fallen Angel Graphic Oversized T-Shirt featuring bold angel-inspired artwork and distressed graphic typography.',
    washingInstructions: [
      'Machine wash cold',
      'Wash inside out to protect the graphic',
      'Use mild detergent',
  ...
  {
    id: 'teecode-brooklyn-new-york-washed-oversized-t-shirt',
    name: 'TEECODE Brooklyn New York Washed Oversized T-Shirt',
    price: 1999,
    salePrice: 999,
    description: 'Bring effortless urban style to your everyday rotation with the TEECODE Brooklyn New York Washed Oversized T-Shirt. Inspired by classic American streetwear, this statement tee features bold “BROOKLYN” varsity lettering with “NEW YORK” detailing across the chest.\n\nThe distinctive washed finish gives the fabric a vintage, lived-in character, while the oversized silhouette creates a relaxed contemporary look. Dropped shoulders, roomy sleeves, and a comfortable crew neckline make it ideal for all-day wear.\n\nAvailable in four versatile variants, so you can choose the one that best matches your style.\n\nStyle Note: Designed for an intentionally oversized fit. Choose your usual size for the full relaxed look or size down for a slightly more fitted silhouette.',
    fit: 'Oversized / Relaxed Fit',
    fitType: 'Oversized',
    gsm: 240,
    material: '240 GSM Premium Cotton, vintage washed finish',
    printFront: 'BROOKLYN – NEW YORK front varsity graphic',
    printBack: 'Plain vintage washed back',
    style: 'Vintage Streetwear — Men\'s / Unisex',
    sizes: ['XXS', 'XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Black', hex: '#0F0F11' },
      { name: 'Maroon', hex: '#800020' },
      { name: 'Green', hex: '#2D4F3B' },
      { name: 'Blue', hex: '#1E3A5F' },
    ],
    images: [
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805397/brooklyn_tshirt_closeup_m0tcva.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805399/model_back_view_dumbo_usf1dk.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805399/dumbo_brooklyn_model_pa03zx.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805399/maroon_acid_wash_tee_qfjuus.webp',
      'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805399/forest_green_tshirt_closeup_mxp4kk.webp',
    ...
    colorImages: {
      ...
      'Maroon': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805399/maroon_acid_wash_tee_qfjuus.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805397/back_view_maroon_tee_zydghg.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805399/dumbo_brooklyn_fashion_dxfzfm.webp',
      ],
      'Green': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805399/forest_green_tshirt_closeup_mxp4kk.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805397/back_view_fashion_shot_jjy5wo.webp',
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805397/brooklyn_fashion_full_body_qoubys.webp',
      ],
      'Blue': [
        'https://res.cloudinary.com/dtzyjynai/image/upload/v1788805938/792a91dc-c0f4-43ad-8fc9-bcbb448dedac_xuatjr.png',
    ...
    additionalTypes: ['Oversized Collection', 'Washed Edition', 'Graphic Universe'],
    tag: '50% OFF',
    graphicDesc: 'TEECODE Brooklyn New York Washed Oversized T-Shirt in vintage washed finish featuring bold varsity lettering, dropped shoulders, and relaxed streetwear fit.',
    washingInstructions: [
      'Machine wash cold inside out with like colors',
      'Wash on gentle cycle to preserve vintage washed finish and graphic',
      'Do not bleach',
